...
describe('SaveProjectPopupComponent', () => {
  ...
  beforeEach(async () => {
    ...
    globalServiceMock = {
      ...
      getIsFork: jest.fn().mockReturnValue(false),
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [
        ...
        { provide: Draw, useValue: drawServiceMock as unknown as Draw },
        {
          ...
          useValue: firebaseServiceMock as unknown as FirebaseService,
        },
        {
          provide: DialogService,
          useValue: dialogServiceMock as unknown as DialogService,
        },
      ],
    }).compileComponents();
  ...
  describe('Form Management', () => {
    ...
    it('TC-POPUP-004: should prefill form with existing project data', () => {
      ...
      expect(firebaseServiceMock.getProjectById).toHaveBeenCalledWith(
        'existing-project-id',
      );
  ...
  describe('Project Saving', () => {
    it('TC-POPUP-005: should save project', async () => {
      ...
      expect(drawServiceMock.saveProjectToFirebase).toHaveBeenCalledWith(
        'My Project',
        false,
        false,
      );
